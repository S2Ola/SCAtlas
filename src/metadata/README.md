 ...
 * [scao.yml](scao.yml)
     * Determines how your purl.obolibrary.org/obo/scao/ redirects will be handled
     ...
     * Paste in the contents of [scao.yml](scao.yml)
 ...
 * [scao.md](scao.md)
     ...
     * Paste in the contents of [scao.md](scao.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
