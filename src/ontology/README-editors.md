These notes are for the EDITORS of scao
...
Make sure you have an ID range in the [idranges file](scao-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [scao-edit.owl](scao-edit.owl)

** DO NOT EDIT scao.obo OR scao.owl in the top level directory **

[../../scao.owl](../../scao.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/S2Ola/scao) for details.
 ...
 * [scao-idranges.owl](scao-idranges.owl)
...
This generates derived files such as scao.owl and scao.obo and places
